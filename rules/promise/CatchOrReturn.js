 ...
 * Ensures that promises either include a catch() handler or are returned.
 * Adapted from eslint-plugin-promise (MIT License).
 */

import isPromise from "./lib/IsPromise.js";
import isMemberCallWithObjectName from "./lib/IsMemberCallWithObjectName.js";
...
const catchOrReturn = {
	...
	create(context)
	{
		...
		/**
		 * Checks if the expression is an allowed promise termination.
		 *
		 * @param {import("estree").Node} expression - The expression to check.
		 * @returns {boolean} Whether the expression terminates the promise properly.
		 */
